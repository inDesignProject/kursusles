<?php
	...
	if($enkripsi->decode($_GET['func']) == "resetPassword" && isset($_GET['func'])){
		...
		if($_POST['reset_type'] == 1){
			$sqlCek		=	sprintf("SELECT B.EMAIL, B.NAMA, A.USERNAME, A.IDUSER
									 FROM m_user A
									 LEFT JOIN m_pengajar B ON A.IDUSER_CHILD = B.IDPENGAJAR
									 WHERE B.EMAIL = '%s' AND A.IDLEVEL = %s
									 LIMIT 0,1"
									, $_POST['email']
									, $_POST['reset_type']
								);
		...
		if($resultCek <> "" && $resultCek <> false){
			...
			$message	=	"<html>
							...
							<body>
								...
								Anda meminta untuk mengatur ulang akun di KursusLes dengan data:<br /><br/>
								...
								".APP_URL."signup_activation/?t=".$enkripsi->encode('resetPwd')."&u=".$enkripsi->encode($resultCek['IDUSER'])."&p=".md5($_POST['password'])."
								<br /><br />
							
								abaikan email ini jika anda tidak merasa meminta pengaturan ulang akun yang ada di KursusLes.com.<br /><br /><br><br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <input type="radio" id="reset_type" name="reset_type" value="1" checked /> <small>Pengajar</small>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <input type="radio" id="reset_type" name="reset_type" value="2" /> <small>Murid</small>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            </div>
                                        </div>
