...
<form class="form-inline" method="POST" action="../dev1/auth">
    <!--<div class="form-group">
		<label><small>Login sebagai: </small></label>
        <input type="radio" id="login_type" name="login_type" value="1" param_t1 /> <small>Pemberi Kerja</small>
        <input type="radio" id="login_type" name="login_type" value="2" param_t2 /> <small>Pencari Kerja</small>
    </div><br/>-->
    <div class="form-group">
    ...
    <div class="tombol text-right">
		...
		<a href="../dev1/signup" class="btn btn-custom btn-xs">DAFTAR</a>
    </div>
</form>