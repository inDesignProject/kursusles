                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="info">
                            <div class="infolist" id="toplist">
                                <i class="fa fa-home"></i> &nbsp; <?=$result['ALAMAT_KANTOR']." ".$result['NAMA_PROPINSI']." ".$result['NAMA_KOTA']?></b><br/>
                                <i class="fa fa-paper-plane-o"></i> &nbsp; <?=$result['KODEPOS']?><br/>
                                <i class="fa fa-phone"></i> &nbsp; <?=$result['TELPON']?><br/>
                                <i class="fa fa-envelope-o"></i> &nbsp; <?=$result['EMAIL']?><br/>
