                                    ...
                                    <div class="form-group">
                                       ...
                                       <!-- <hr></hr>-->
                                        <div class="row">
                                            ...
                                            <!--    <input type="radio" id="login_type" name="login_type" value="1" <?=$_GET['t'] <> "1" ? "" : "checked"?> /> <small>Pengajar</small>-->
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                          <!--                      <input type="radio" id="login_type" name="login_type" value="2" <?=$_GET['t'] <> "2" ? "" : "checked"?> /> <small>Murid</small>-->
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
