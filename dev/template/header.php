                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbar_kursusles">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="APP_URLsearch_detail">CARI PENGAJAR</a></li>
                                <!--<li><a href="APP_BASE_URLloker">LOWONGAN</a></li>-->
                                <li><a href="APP_BASE_URLloker">LOWONGAN</a></li>
                                <!--<li><a href="APP_URLloker/index_pers">PROFIL</a></li>-->
                                <li><a href="APP_URLtutorial">TUTORIAL</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
